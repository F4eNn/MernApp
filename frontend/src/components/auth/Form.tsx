import { Form as ReactForm, FormProps } from 'react-router-dom';
...
export const Form = ({ title, children, ...rest }: AuthCardProps) => {
	return (
		<div className='mx-3 mt-20 flex  justify-center '>
			<ReactForm {...rest} className='bg-gray flex w-full max-w-[400px] flex-col items-center gap-5 rounded-md p-7 pb-7'>
